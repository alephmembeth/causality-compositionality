...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SLIDE 3 – A TALE OF THREE PAPERS %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SLIDE 5 – LIVENGOOD AND SYTSMA (2020) %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{overlayarea}{\textwidth}{0.81\paperheight}{
   \vspace*{11mm}
   \usebeamerfont{title}\textcolor{uolblue}
   {2\hspace*{1em}Livengood and Sytsma (2020)}
}
\end{overlayarea}
\end{frame}
...
\vfill
\begin{center}
   \frame{\includegraphics[width=\linewidth]{figures/livengood_sytsma_2020_fig_1.png}}
\end{center}
\end{multicols}
\note{
   \begin{itemize}
      \item each participant (34) completely agrees with (A); $M=7$
      \item two-thirds of participants (22) completely disagree with (B); $M=2.06$
      \item central tendency of responses is significantly above/below 4 (neutral value, midpoint)
   \end{itemize}
}
\end{frame}
...
\note{
   \begin{itemize}
      \item 48 (nearly) completely agree with (A), choosing 6 or 7; central tendency of responses is significantly above 4; $M=6.71$
      \item not so for (B) and (C), where central tendency is significantly below 4; $M$ not reported
      \item assessments of (D) are bimodal; central tendency not significantly different from 4; $M$ not reported
   \end{itemize}
}
\end{frame}
...
\vfill
\begin{center}
   \frame{\includegraphics[width=\linewidth]{figures/livengood_sytsma_2020_fig_9_1.png}}
   \frame{\includegraphics[width=\linewidth]{figures/livengood_sytsma_2020_fig_9_2.png}}
\end{center}
\end{multicols}
\note{
   \begin{itemize}
      \item 72 participants completely agree with (A), another 30 respond with 6; $M=5.48$
      \item answers for (B) tend to disagree; $M=3.67$
      \item central tendency of responses is significantly above/below 4
      \item hence, CCAC violated; intermediaries by which effect is caused indirectly are not deemed to be an actual cause of $e$
   \end{itemize}
}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SLIDE 13 – BAUER AND ROMANN (2022) %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{overlayarea}{\textwidth}{0.81\paperheight}{
   \vspace*{11mm}
   \usebeamerfont{title}\textcolor{uolblue}
   {3\hspace*{1em}Bauer and Romann (2022)}
}
\end{overlayarea}
\end{frame}
...
\vspace*{-5mm}
\textbf{Structure of Revolver Vignette}\\
\begin{center}
   \includegraphics[width=.8\linewidth]{figures/revolver_2.pdf}
\end{center}
\end{frame}
...
\begin{frame}{\vspace*{10mm}3\hspace*{1em}Bauer and Romann (2022)}
\vspace*{-5mm}
\textbf{Questions of Revolver Vignette}\\
\begin{center}
   \includegraphics[width=.8\linewidth]{figures/revolver_3.pdf}
\end{center}
\note{
   \begin{itemize}
...
\note{
   \begin{itemize}
      \item did element $X$ cause the final effect, $H$?
   \end{itemize}
}
\end{frame}
...
\note{
   \begin{itemize}
      ...
      \item my, by that time vague, idea about this: albeit LS tried to avoid this, the selected statements might have led subjects to think about causation in terms of responsibility
...
\note{
   \begin{itemize}
      \item to see if this makes a difference, had to include statements that are similar
      \item due to method of construction, going back and extracting more fine grained events, ended up with slightly different formulations, but consider the following to be (more or less) similar
   \end{itemize}
}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SLIDE 22 – BAUER AND KORNMESSER (2023) %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{overlayarea}{\textwidth}{0.81\paperheight}{
   \vspace*{11mm}
...
\note{
   \begin{itemize}
      \item exclusion by changing statements
...
\begin{center}
   \frame{\includegraphics[width=0.35\linewidth]{figures/bauer_kornmesser_2023_tab_2_1.png}}
\end{center}
\note{
   \begin{itemize}
      \item \textbf{Intermediary-Ontology Confusion:} using events instead of individuals as intermediaries
      \item \textbf{Causation-Responsibility Confusion:} not using the word ``cause''; counterfactual formulation
      \item \textbf{Cause-End Questioning:} using statements in which an intermediary $d_1$ is the cause of an effect that is not the end link of the causal chain but a further intermediary $d_2$, similar to Bauer and Romann (2022)
   \end{itemize}
}
\end{frame}
...
\note{
   \begin{itemize}
      \item Intermediary-Ontology Confusion
      \item Causation-Responsibility Confusion
      \item Cause-End Questioning
   \end{itemize}
}
\end{frame}
...
\vspace*{-5mm}
\begin{center}
      \frame{\includegraphics[width=0.5\linewidth]{figures/bauer_kornmesser_2023_fig_2.png}}\\

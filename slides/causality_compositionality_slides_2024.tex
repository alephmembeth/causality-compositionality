...
\note{
   \begin{itemize}
      ...
      \item due to method of construction, ended up with slightly different formulations, but consider the following to be (more or less) similar
   \end{itemize}
}
\end{frame}
...
\begin{multicols}{2}
\begin{center}
   \frame{\includegraphics[width=0.65\linewidth]{figures/bauer_kornmesser_2023_tab_2_1.png}}
   \vfill
   \frame{\includegraphics[width=0.7\linewidth]{figures/bauer_kornmesser_2023_fig_2_1.png}}
   \frame{\includegraphics[width=0.7\linewidth]{figures/bauer_kornmesser_2023_fig_2_2.png}}
\end{center}
\end{multicols}
\note{
   \begin{itemize}

...
/* Labels */
use "causality_compositionality_study_data.dta", clear
...
preserve /* Vignette 1, replication */
   ...
   graph export "causality_compositionality_study_cup_rep_hist_1.pdf", as(pdf) replace
   ...
   hist vig1rep2, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_rep_hist_2.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_rep_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 1, event */
   ...
   hist vig1eve11, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_ioc_1_hist_1.pdf", as(pdf) replace
   ...
   hist vig1eve12, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_ioc_1_hist_2.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                legend(label(1 "Gabi") label(2 "Kathrin") label(3 "95% CI")) ///
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_ioc_1_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 1, event without name */
   ...
   hist vig1eve21, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_ioc_2_hist_1.pdf", as(pdf) replace
   ...
   hist vig1eve22, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_ioc_2_hist_2.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                legend(label(1 "Gabi") label(2 "Kathrin") label(3 "95% CI")) ///
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_ioc_2_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 1, term */
   ...
   hist vig1def1, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_crc_hist_1.pdf", as(pdf) replace
   ...
   hist vig1def2, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_crc_hist_2.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                legend(label(1 "Gabi") label(2 "Kathrin") label(3 "95% CI")) ///
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_crc_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 1, chain */
   ...
   hist vig1cha1, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_ceq_hist_1.pdf", as(pdf) replace
   ...
   hist vig1cha2, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_ceq_hist_2.pdf", as(pdf) replace
   ...
   hist vig1cha3, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_ceq_hist_3.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_ceq_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 1, combination */
   ...
   hist vig1com1, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_com_hist_1.pdf", as(pdf) replace
   ...
   hist vig1com2, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_com_hist_2.pdf", as(pdf) replace
   ...
   hist vig1com3, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_com_hist_3.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                legend(label(1 "Gabi") label(2 "Kathrin") label(3 "Nele") label(4 "95% CI")) ///
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_cup_com_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 2, replication */
   ...
   hist vig2rep1, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_rep_hist_1.pdf", as(pdf) replace
   ...
   hist vig2rep2, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_rep_hist_2.pdf", as(pdf) replace
   ...
   hist vig2rep3, percent discrete barwidth(.8) ///
	  ...
	  ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_rep_hist_3.pdf", as(pdf) replace
   ...
   hist vig2rep4, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_rep_hist_4.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_rep_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 2, event */
   ...
   hist vig2eve1, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_ioc_hist_1.pdf", as(pdf) replace
   ...
   hist vig2eve2, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_ioc_hist_2.pdf", as(pdf) replace
   ...
   hist vig2eve3, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_ioc_hist_3.pdf", as(pdf) replace
   ...
   hist vig2eve4, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_ioc_hist_4.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                legend(label(1 "Leeve") label(2 "Hammer") label(3 "Gunpowder") label(4 "Bullet") label(5 "95% CI")) ///
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_ioc_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 2, term */
   ...
   hist vig2def1, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_crc_hist_1.pdf", as(pdf) replace
   ...
   hist vig2def2, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_crc_hist_2.pdf", as(pdf) replace
   ...
   hist vig2def3, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_crc_hist_3.pdf", as(pdf) replace
   ...
   hist vig2def4, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_crc_hist_4.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                legend(label(1 "Leeve") label(2 "Hammer") label(3 "Gunpowder") label(4 "Bullet") label(5 "95% CI")) ///
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_crc_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 2, chain */
   ...
   hist vig2cha1, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_ceq_hist_1.pdf", as(pdf) replace
   ...
   hist vig2cha2, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_ceq_hist_2.pdf", as(pdf) replace
   ...
   hist vig2cha3, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
	graph export "causality_compositionality_study_rev_ceq_hist_3.pdf", as(pdf) replace
   ...
   hist vig2cha4, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_ceq_hist_4.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                legend(label(1 "Leeve") label(2 "Hammer") label(3 "Gunpowder") label(4 "Bullet") label(5 "95% CI")) ///
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_ceq_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 2, combination */
   ...
   hist vig2com1, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_com_hist_1.pdf", as(pdf) replace
   ...
   hist vig2com2, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_com_hist_2.pdf", as(pdf) replace
   ...
   hist vig2com3, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_com_hist_3.pdf", as(pdf) replace
   ...
   hist vig2com4, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_com_hist_4.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                legend(label(1 "Leeve") label(2 "Hammer") label(3 "Gunpowder") label(4 "Bullet") label(5 "95% CI")) ///
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_rev_com_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 3, replication */
   ...
   hist vig3rep1, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_rep_hist_1.pdf", as(pdf) replace
   ...
   hist vig3rep2, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_rep_hist_2.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_rep_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 3, event */
   ...
   hist vig3eve1, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_ioc_hist_1.pdf", as(pdf) replace
   ...
   hist vig3eve2, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_ioc_hist_2.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                legend(label(1 "Pipe") label(2 "Circuit") label(3 "95% CI")) ///
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_ioc_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 3, term with conditional */
   ...
   hist vig3def11, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_crc_hist_1.pdf", as(pdf) replace
   ...
   hist vig3def12, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_crc_hist_2.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                legend(label(1 "Pipe") label(2 "Circuit") label(3 "95% CI")) ///
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_crc_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 3, chain */
   ...
   hist vig3cha1, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_ceq_hist_1.pdf", as(pdf) replace
   ...
   hist vig3cha2, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_ceq_hist_2.pdf", as(pdf) replace
   ...
   hist vig3cha3, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_ceq_hist_3.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_ceq_bar.pdf", as(pdf) replace
restore
...
preserve /* Vignette 3, combination with conditional */
   ...
   hist vig3com11, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_com_hist_1.pdf", as(pdf) replace
   ...
   hist vig3com12, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_com_hist_2.pdf", as(pdf) replace
   ...
   hist vig3com13, percent discrete barwidth(.8) ///
      ...
      ylabel(0(10)100, angle(0)) ///
      graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_com_hist_3.pdf", as(pdf) replace
   ...
   graph twoway (bar meantemp statement if statement == 1, bcolor(gs2) barw(0.4)) ///
                ...
                legend(label(1 "Pipe") label(2 "Circuit") label(3 "Lamp") label(4 "95% CI")) ///
				graphregion(fcolor(white))
   graph export "causality_compositionality_study_cir_com_bar.pdf", as(pdf) replace
restore
